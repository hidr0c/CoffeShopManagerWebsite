...
export default function Import () {
  ...
  return (
    <div className="">
        <Select label="Tên nhà cung cấp" value="Luu Minh Tri Supplier" options={[{value: 'Luu Minh Tri Supplier', label:'Luu Minh Tri Supplier'},{value: 'Test 2', label:'Test2'}]} onChange={() => handleSelect()}></Select>
