...
export default function WareHouse () {
  ...
  return (
    <div className="">
        ...
        <TableBody>
          {data.map((item,index) => (
            ...
            <TableCell>
              ...
              <div className="" style={{color: '#624DE3',cursor:'pointer'}} onClick={() => openModal()}><FaRegEdit /></div>
      ...
      <Modal title="Chỉnh sửa kho hàng" isOpen={isModalOpen} onClose={closeModal} style={{width:'50vw', background:"#FFCC99"}}>
